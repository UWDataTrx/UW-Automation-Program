...
def generate_setup_pdf():
    """Generate PDF from the SETUP_GUIDE.txt file using ReportLab."""

    # Get the current directory
    current_dir = Path(__file__).parent

    # Input and output file paths
    txt_file = current_dir / "SETUP_GUIDE.txt"
    pdf_file = current_dir / "SETUP_GUIDE.pdf"
    ...
    try:
        ...
        story.append(Paragraph("Setup Guide", subtitle_style))
        ...
        while i < len(lines):
            ...
            # Handle code blocks (if any exist in the setup guide)
            elif line.startswith("```"):
            ...
            # Handle numbered lists
                ...
                story.append(
                    Paragraph(f"{line.split('.')[0]}. {list_text}", numbered_style)
                )
        ...
        print("✅ Setup guide PDF generated successfully!")
        ...
        print(f"❌ Error generating setup PDF: {e}")
        return None
