...
def process_data():
    ...
    try:
        ...
        if 'reprice' not in paths or not paths['reprice']:
            ...
            write_shared_log("openmdf_bg.py", "No reprice/template file provided.", status="ERROR")
        ...
        logger.exception(f"Open MDF BG processing failed: {e}")
        write_shared_log("openmdf_bg.py", f"Processing failed: {e}", status="ERROR")
