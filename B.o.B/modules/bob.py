...
def read_drug_data(file_path):
    ...
    try:
        ...
        required_cols = ["affiliate_ingred_cost", "affiliate_disp_fee", "days_supply", "drug_name", "strength", "quantity"]
        missing_cols = [col for col in required_cols if col not in data.columns]
        if missing_cols:
            messagebox.showerror("Missing Columns", f"The following columns are missing: {', '.join(missing_cols)}")
            return None
