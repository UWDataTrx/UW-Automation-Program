    ...
    for drug in drug_names:
        ...
        if not drug_info.empty:
            ...
            if quantity is not None:
                drug_info = drug_info[
                    drug_info['quantity'].str.lower().str.contains(quantity.strip().lower(), na=False)]
            ...
            # Rename columns
            drug_pt.columns = ['drug_name', '30/90', 'strength', 'quantity', 'mean_cost', 'mode_cost', 'fill_count']
            ...
            results.append(
                pd.DataFrame(columns=["drug_name", "quantity", "30/90", "strength", "mean_cost", "mode_cost", "fill_count"]))
...
columns = ["Drug Name", "Quantity", "30/90 Day Supply", "Dosing", "Average Cost", "Mode Cost", "Fill Count"]
