    ...
    try:
        ...
        if "pharmacy_is_excluded" in df.columns:
            ...
            if not na_pharmacies.empty:
                ...
                # Ensure 'writer' is properly initialized before use
                writer = pd.ExcelWriter(output_file_path, engine="openpyxl")

                na_pharmacies_output = na_pharmacies[["PHARMACYNPI", "NABP"]].fillna(
                    "N/A"
                )
        ...
        # Prepare tier pivots and Exclusions, but do not write yet
        tiers = [
